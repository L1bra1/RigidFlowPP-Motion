"""
The architecture of self-supervised MotionNet
Some of the code are modified based on 'model.py' in MotionNet.
...
class SelfMotionNet(nn.Module):
    def __init__(self, out_seq_len=1, height_feat_size=13):
        super(SelfMotionNet, self).__init__()
